...
名称| 说明| 默认值| 备注  
---|---|---|---  
enable| 是否开启| true| 关闭后交互性触发器将不会触发（影响子组件）  
...
bottom_center| 底部中间  
bottom_right| 右下角  
[Previous控件结构](/docs/core/8_ui/6_controls_config)[Next控件类型](/docs/core/8_ui/8_controls_type)
