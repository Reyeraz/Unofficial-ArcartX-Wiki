...
**match**
  ...
  * 注意，在2025.8之前的版本中，ID为原版的class名，后由于Fabric采用中介名，AX内置了友好名称字典（中文），在现有教学中，可能仍存在原始用法，请注意甄别，替换为最新写法。
...
**hide**
  ...
  * 对于Fabric，`player_state`(对应player_health armor_level food_level air_level) 没有`debug`
