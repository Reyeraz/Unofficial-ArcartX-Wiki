...
## `Camera.clearState()`
  ...
  * **调用示例**
    ...
    Camera.clearState()
## `Camera.setStateScene(x, y, z, yaw, pitch)`
  * 设置单步场景相机位置
...
## `Camera.clearStateScene()`
  ...
  * **调用示例**
    ...
    Camera.clearState()
[PreviousMouse:鼠标](/docs/shimmer/3_arcartx/1_functions/21_mouse)[NextTip:工具提示](/docs/shimmer/3_arcartx/1_functions/23_tip)
